...
class RAGPT2Model_v1(nn.Module):

    '''given context $c_i$, recall top-k candidates from corpus, concatenate top-k candidate and the context to generate the response in auto-aggressive way.'''

    def __init__(self, **args):
        super(RAGPT2Model_v1, self).__init__()
